...
1. [SQL デプロイ オプションを選択する] ブレードで、[SQL 仮想マシン] の下のドロップダウン ボックスを開きます。 **Free SQL Server License: SQL 2019 Developer on Windows Server 2019** というラベルの付いたオプションを選択して [作成] ボタンを選択します。
    
    ![画像 11](../images/dp-3300-module-11-lab-11.png)

1. [仮想マシンの作成] ブレードで、次の情報を入力します。 
    ...
    - イメージ:**Free SQL Server License: SQL 2019 Developer on Windows Server 2019**
...
1. [Monitoring] タブに移動し、構成を確認します。
    **[Boot diagnostics]** で **[Enable with managed storage account (recommended)]** が選択されていることを確認します。 
...
1. [確認および作成] ボタンを選択します。 [作成] ボタンを選択します。  
  ![画像 18](../images/dp-3300-module-11-lab-18.png)


1. デプロイ ブレードで、デプロイが完了するまで待ちます。 VM のデプロイには約 5 - 10 分かかります。 次に、[リソースに移動] ボタンを選択します。 

    ![画像 19](../images/dp-3300-module-11-lab-19.png)

 
1. 仮想マシンの概要ページで、リソースのメニュー オプションをスクロールして、使用可能な内容を確認します。
