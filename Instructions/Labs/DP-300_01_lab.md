...
2. [SQL デプロイ オプションを選択する] ブレードで、[SQL 仮想マシン] の下のドロップダウン ボックスを開きます。 **Free SQL Server License: SQL 2019 Developer on Windows Server 2019** というラベルの付いたオプションを選択して [作成] ボタンを選択します。
